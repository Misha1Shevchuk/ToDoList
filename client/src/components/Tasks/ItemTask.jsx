...
export default class ItemTask extends React.Component {
    ...
    markCompleted = async event => {
        ...
        await axios.post(`/task-checkbox-active`, {
            id_task: this.props.element.id_task,
        ...
        return (
            <li className={classes.item_li} >
                {this.state.showChangeTaskForm ?
                    <ChangeTask showChangeTaskForm={this.showChangeTaskForm} getList={this.props.getList}
                        element={this.props.element} />
                    : <div className={classes.item}>
                        <input onClick={this.markCompleted} defaultChecked={this.state.isCompleted} type="checkbox" id={`checkbox_${this.props.element.id_task}`} className={classes.checkbox} />
                        <label htmlFor={`checkbox_${this.props.element.id_task}`}></label>
                        <span className={classes.item_name}>  {this.props.element.task}</span>
                        <div className={classes.buttons_block}>
                            <button onClick={this.showChangeTaskForm} className={classes.item_change_button}>
                                <img src="img/pencil.svg" alt="change" />
                            </button>
                            <button onClick={this.removeTask} className={classes.item_delete_button}>
